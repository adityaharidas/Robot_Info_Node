...
RobotInfo::RobotInfo(ros::NodeHandle* nh, std::string robot_description, std::string serial_number,std::string ip_address, std::string firmware_version)
{
    this->nh = nh;
    robot_info_publisher = nh->advertise<robotinfo_msgs::RobotInfo10Fields>("robot_info", 1000);
